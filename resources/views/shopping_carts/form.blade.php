    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
                <input type="numeric" class="form-control" placeholder="Ingresa tu nombre" id="cliente" name="cliente" >
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
                <input type="text" class="form-control" placeholder="Dirección" id="direccion" name="direcion">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
                <input type="text" class="form-control" placeholder="Ingresa tu correo" id="correo" name="correo">
        </div>
    </div>
    <div class="form-group row">
        <label class="col-md-3 form-control-label" for="des">Teléfono</label>
        <div class="col-md-9">
                <input type="text" class="form-control" placeholder="Ingresa tu número de telefono" id="telefono" name="telefono">
        </div>
    </div>
    <div class="form-group row">
        <label class="col-md-3 form-control-label" for="des">Método de pago</label>
        <div class="col-md-9">
                <input type="text" class="form-control" placeholder="Método de pago" id="formapago" name="formapago">
        </div>
    </div>
