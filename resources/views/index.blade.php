...
<div class="features">
	<div class="container">
		<div class="heading-setion-w3ls">
			<h2 class="title-w3layouts">Para tí <i class="fas fa-gifts"></i></h2>
		</div>
		<div class="col-md-4 servies-agileinfo">
		<p class="pink-w3ls">Para ocaciones especiales</p>
		<p class="para-w3agileits">Contamos con una gran coleccion de productos</p>
		</div>
		<div class="col-md-4 servies-agileinfo">
			<ul>
				<li><i class="fa fa-diamond" aria-hidden="true"></i>Prendas</li>
				<li><i class="fa fa-diamond" aria-hidden="true"></i>Accesorios</li>
				<li><i class="fa fa-diamond" aria-hidden="true"></i>Juguetes</li>
		...
		<div class="agileits-w3layouts-footer">
			<div class="container">
				<div class="col-md-4 w3-agile-grid">
					<h5>Nosotros</h5>
					<p>Somos tu confidente, el guardián de tus íntimos deseos</p>
					...
					<div class="w3-address">
						...
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								...
								<p>Email :<a href="mailto:consientemeamormio@gmail.com"> consientemeamormio@gmail.com</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="w3-address-grid">
